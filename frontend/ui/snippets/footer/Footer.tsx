  ...
  const BLOCKSCOUT_LINKS = [
    {
      ...
      iconSize: '18px',
      text: 'Twitter',
      url: 'https://www.twitter.com/onlylayer',
    },
    {
      icon: discordIcon,
      iconSize: '18px',
    ...
    >
      <Box flexGrow="1" mb={{ base: 8, lg: 0 }} minW="195px">
        ...
        <Box mt={{ base: 5, lg: '44px' }}>
          <Link fontSize="xs" href="https://onlylayer.com">onlylayer.com</Link>
        </Box>
        <Text mt={ 3 } maxW={{ base: 'unset', lg: '470px' }} fontSize="xs">
            ONLYSCAN is the blockchain explorer for the ONLYLAYER network.
        </Text>
      </Box>
      <Grid
      ...
      >
        <Box>
          { config.UI.footer.links && <Text fontWeight={ 500 } mb={ 3 }>OnlyLayer</Text> }
          <Grid
            gap={ 1 }
            gridTemplateColumns={
